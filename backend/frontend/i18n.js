...
(function () {
  ...
  const DICTIONARIES = {
    fr: {
      ...
      "workspace.greeting_prefix": "Bonjour",
      "workspace.greeting_suffix": ",",
      ...
      "workspace.add_description_placeholder": "Ajouter une description",
      "workspace.copy_response": "Copier",
      "workspace.copied_feedback": "Copié !",
      "workspace.copy_error": "Impossible de copier.",
      "workspace.download_pdf": "Télécharger en PDF",
      "workspace.download_conversation_pdf": "Télécharger la discussion en PDF",
      "workspace.pdf_export_error": "Impossible de générer le PDF.",
      "workspace.reply": "Répondre",
      "workspace.replying_to": "Réponse à :",
      "workspace.mention_no_results": "Aucune personne trouvée.",
      "workspace.cancel_reply": "Annuler la réponse",
      ...
      "workspace.connection_entry_api_key": "Entrée 1 : clé API (facultatif)",
      "workspace.connection_auth_bearer": "En-tête Authorization (Bearer)",
      "workspace.connection_auth_header": "En-tête personnalisé",
      "workspace.connection_auth_query": "Paramètre d'URL",
      "workspace.connection_auth_field_placeholder": "Nom du champ (ex : X-API-Key)",
      "workspace.connection_entry_oauth": "Entrée 2 : connexion OAuth (facultatif)",
      "workspace.connection_oauth_client_id_placeholder": "Client ID",
      "workspace.connection_oauth_client_secret_placeholder": "Client Secret",
      "workspace.connection_oauth_authorize_url_placeholder": "URL d'autorisation",
      "workspace.connection_oauth_token_url_placeholder": "URL de jeton (token)",
      "workspace.connection_oauth_scope_placeholder": "Scope (optionnel)",
      "workspace.oauth_connect": "Se connecter (OAuth)",
      "workspace.oauth_disconnect": "Déconnecter (OAuth)",
      "workspace.connection_entry_mcp": "Entrée 3 : serveur MCP (facultatif)",
      "workspace.connection_mcp_url_placeholder": "URL du serveur MCP",
      "workspace.connection_mcp_auth_none": "Aucune authentification",
      "workspace.connection_mcp_token_placeholder": "Jeton d'authentification (optionnel)",
      "workspace.connections_oauth_connected": "Plateforme connectée avec succès.",
      "workspace.connections_oauth_error": "La connexion OAuth a échoué. Réessayez.",
      "workspace.delete_connection": "Supprimer la connexion",
      "workspace.confirm_delete_connection": "Supprimer la connexion « {name} » ?",
      "workspace.mode_message": "Message",
      "workspace.original_message_unavailable": "Message original indisponible",
      "workspace.original_message_not_loaded": "Message original non chargé dans cette vue.",
      "workspace.attachment_only": "Pièce jointe",
      "workspace.move_to_project": "Déplacer dans un autre projet",
      "workspace.move_to_shared_project": "Déplacer dans un autre projet commun",
      "workspace.no_other_projects": "Aucun autre projet",
      "workspace.opt_connect_drive": "Connecter Google Drive",
      "workspace.opt_disconnect_drive": "Déconnecter Google Drive",
      "workspace.google_drive_connected": "Compte Google Drive connecté avec succès.",
      "workspace.google_drive_error": "Impossible de connecter Google Drive.",
      "workspace.google_drive_not_connected": "Connectez votre compte Google Drive depuis le menu profil (Plus d'options).",
      "workspace.google_drive_no_reference_found": "Aucun lien ou identifiant Google Drive valide trouvé dans votre demande.",
      "workspace.google_drive_document_not_found": "Ce document Google Drive est introuvable.",
      "workspace.google_drive_permission_denied": "Vous n'avez pas la permission d'accéder à ce document.",
      "workspace.google_drive_document_too_large": "Ce document est trop volumineux pour être résumé.",
      ...
      "workspace.delete_button_confirm": "Supprimer définitivement ce bouton de la banque partagée ? Cette action est irréversible.",
      "workspace.documentation_entry": "Documentation",
      "workspace.documentation_title": "Documentation",
      "workspace.documentation_search_placeholder": "Rechercher un document...",
      "workspace.documentation_upload": "Ajouter un document",
      "workspace.documentation_load_more": "Charger plus",
      "workspace.documentation_open": "Ouvrir",
      "workspace.documentation_reindex": "Réindexer",
      "workspace.documentation_delete_confirm": "Supprimer définitivement « {name} » ? Cette action est irréversible.",
      "workspace.documentation_status_uploaded": "En attente",
      "workspace.documentation_status_processing": "Indexation...",
      "workspace.documentation_status_ready": "Prêt",
      "workspace.documentation_status_failed": "Échec",
      "workspace.notifications_button": "Notifications",
      "workspace.notifications_title": "Notifications",
      "workspace.notifications_mark_all_read": "Tout marquer comme lu",
      "workspace.notifications_empty": "Aucune notification pour le moment.",
      "workspace.notification_mention": "{name} vous a tagué",
      "workspace.notification_reply": "{name} a répondu à votre message",
    },
    en: {
      ...
      "workspace.greeting_prefix": "Hello",
      "workspace.greeting_suffix": ",",
      ...
      "workspace.add_description_placeholder": "Add a description",
      "workspace.copy_response": "Copy",
      "workspace.copied_feedback": "Copied!",
      "workspace.copy_error": "Could not copy.",
      "workspace.download_pdf": "Download as PDF",
      "workspace.download_conversation_pdf": "Download conversation as PDF",
      "workspace.pdf_export_error": "Could not generate the PDF.",
      "workspace.reply": "Reply",
      "workspace.replying_to": "Replying to:",
      "workspace.mention_no_results": "No matching person.",
      "workspace.cancel_reply": "Cancel reply",
      ...
      "workspace.connection_entry_api_key": "Entry 1: API key (optional)",
      "workspace.connection_auth_bearer": "Authorization header (Bearer)",
      "workspace.connection_auth_header": "Custom header",
      "workspace.connection_auth_query": "URL parameter",
      "workspace.connection_auth_field_placeholder": "Field name (e.g. X-API-Key)",
      "workspace.connection_entry_oauth": "Entry 2: OAuth connection (optional)",
      "workspace.connection_oauth_client_id_placeholder": "Client ID",
      "workspace.connection_oauth_client_secret_placeholder": "Client Secret",
      "workspace.connection_oauth_authorize_url_placeholder": "Authorization URL",
      "workspace.connection_oauth_token_url_placeholder": "Token URL",
      "workspace.connection_oauth_scope_placeholder": "Scope (optional)",
      "workspace.oauth_connect": "Connect (OAuth)",
      "workspace.oauth_disconnect": "Disconnect (OAuth)",
      "workspace.connection_entry_mcp": "Entry 3: MCP server (optional)",
      "workspace.connection_mcp_url_placeholder": "MCP server URL",
      "workspace.connection_mcp_auth_none": "No authentication",
      "workspace.connection_mcp_token_placeholder": "Auth token (optional)",
      "workspace.connections_oauth_connected": "Platform connected successfully.",
      "workspace.connections_oauth_error": "The OAuth connection failed. Please try again.",
      "workspace.delete_connection": "Delete connection",
      "workspace.confirm_delete_connection": "Delete the connection “{name}”?",
      "workspace.mode_message": "Message",
      "workspace.original_message_unavailable": "Original message unavailable",
      "workspace.original_message_not_loaded": "Original message not loaded in this view.",
      "workspace.attachment_only": "Attachment",
      "workspace.move_to_project": "Move to another project",
      "workspace.move_to_shared_project": "Move to another shared project",
      "workspace.no_other_projects": "No other project",
      "workspace.opt_connect_drive": "Connect Google Drive",
      "workspace.opt_disconnect_drive": "Disconnect Google Drive",
      "workspace.google_drive_connected": "Google Drive account connected successfully.",
      "workspace.google_drive_error": "Could not connect Google Drive.",
      "workspace.google_drive_not_connected": "Connect your Google Drive account from the profile menu (More options).",
      "workspace.google_drive_no_reference_found": "No valid Google Drive link or ID found in your request.",
      "workspace.google_drive_document_not_found": "This Google Drive document could not be found.",
      "workspace.google_drive_permission_denied": "You don't have permission to access this document.",
      "workspace.google_drive_document_too_large": "This document is too large to summarize.",
      ...
      "workspace.delete_button_confirm": "Permanently delete this button from the shared bank? This cannot be undone.",
      "workspace.documentation_entry": "Documentation",
      "workspace.documentation_title": "Documentation",
      "workspace.documentation_search_placeholder": "Search a document...",
      "workspace.documentation_upload": "Add a document",
      "workspace.documentation_load_more": "Load more",
      "workspace.documentation_open": "Open",
      "workspace.documentation_reindex": "Re-index",
      "workspace.documentation_delete_confirm": "Permanently delete \"{name}\"? This cannot be undone.",
      "workspace.documentation_status_uploaded": "Pending",
      "workspace.documentation_status_processing": "Indexing...",
      "workspace.documentation_status_ready": "Ready",
      "workspace.documentation_status_failed": "Failed",
      "workspace.notifications_button": "Notifications",
      "workspace.notifications_title": "Notifications",
      "workspace.notifications_mark_all_read": "Mark all as read",
      "workspace.notifications_empty": "No notifications yet.",
      "workspace.notification_mention": "{name} tagged you",
      "workspace.notification_reply": "{name} replied to your message",
    },
    ar: {
      ...
      "workspace.greeting_prefix": "مرحبًا",
      "workspace.greeting_suffix": "،",
      ...
      "workspace.add_description_placeholder": "إضافة وصف",
      "workspace.copy_response": "نسخ",
      "workspace.copied_feedback": "تم النسخ!",
      "workspace.copy_error": "تعذر النسخ.",
      "workspace.download_pdf": "تنزيل كملف PDF",
      "workspace.download_conversation_pdf": "تنزيل المحادثة كملف PDF",
      "workspace.pdf_export_error": "تعذر إنشاء ملف PDF.",
      "workspace.reply": "رد",
      "workspace.replying_to": "الرد على:",
      "workspace.mention_no_results": "لا يوجد شخص مطابق.",
      "workspace.cancel_reply": "إلغاء الرد",
      ...
      "workspace.connection_entry_api_key": "الحقل 1: مفتاح API (اختياري)",
      "workspace.connection_auth_bearer": "ترويسة Authorization (Bearer)",
      "workspace.connection_auth_header": "ترويسة مخصصة",
      "workspace.connection_auth_query": "معامل في الرابط",
      "workspace.connection_auth_field_placeholder": "اسم الحقل (مثال: X-API-Key)",
      "workspace.connection_entry_oauth": "الحقل 2: اتصال OAuth (اختياري)",
      "workspace.connection_oauth_client_id_placeholder": "Client ID",
      "workspace.connection_oauth_client_secret_placeholder": "Client Secret",
      "workspace.connection_oauth_authorize_url_placeholder": "رابط التفويض",
      "workspace.connection_oauth_token_url_placeholder": "رابط الحصول على الرمز",
      "workspace.connection_oauth_scope_placeholder": "النطاق (اختياري)",
      "workspace.oauth_connect": "الاتصال (OAuth)",
      "workspace.oauth_disconnect": "قطع الاتصال (OAuth)",
      "workspace.connection_entry_mcp": "الحقل 3: خادم MCP (اختياري)",
      "workspace.connection_mcp_url_placeholder": "رابط خادم MCP",
      "workspace.connection_mcp_auth_none": "بدون مصادقة",
      "workspace.connection_mcp_token_placeholder": "رمز المصادقة (اختياري)",
      "workspace.connections_oauth_connected": "تم ربط المنصة بنجاح.",
      "workspace.connections_oauth_error": "فشل اتصال OAuth. حاول مرة أخرى.",
      "workspace.delete_connection": "حذف الاتصال",
      "workspace.confirm_delete_connection": "حذف الاتصال «{name}»؟",
      "workspace.mode_message": "رسالة",
      "workspace.original_message_unavailable": "الرسالة الأصلية غير متوفرة",
      "workspace.original_message_not_loaded": "الرسالة الأصلية غير محملة في هذا العرض.",
      "workspace.attachment_only": "مرفق",
      "workspace.move_to_project": "نقل إلى مشروع آخر",
      "workspace.move_to_shared_project": "نقل إلى مشروع مشترك آخر",
      "workspace.no_other_projects": "لا يوجد مشروع آخر",
      "workspace.opt_connect_drive": "ربط Google Drive",
      "workspace.opt_disconnect_drive": "إلغاء ربط Google Drive",
      "workspace.google_drive_connected": "تم ربط حساب Google Drive بنجاح.",
      "workspace.google_drive_error": "تعذر ربط Google Drive.",
      "workspace.google_drive_not_connected": "اربط حساب Google Drive من قائمة الملف الشخصي (خيارات إضافية).",
      "workspace.google_drive_no_reference_found": "لم يتم العثور على رابط أو معرّف Google Drive صالح في طلبك.",
      "workspace.google_drive_document_not_found": "تعذر العثور على مستند Google Drive هذا.",
      "workspace.google_drive_permission_denied": "ليس لديك إذن للوصول إلى هذا المستند.",
      "workspace.google_drive_document_too_large": "هذا المستند كبير جدًا ليتم تلخيصه.",
      ...
      "workspace.delete_button_confirm": "هل تريد حذف هذا الزر نهائيًا من البنك المشترك؟ لا يمكن التراجع عن هذا الإجراء.",
      "workspace.documentation_entry": "الوثائق",
      "workspace.documentation_title": "الوثائق",
      "workspace.documentation_search_placeholder": "ابحث عن مستند...",
      "workspace.documentation_upload": "إضافة مستند",
      "workspace.documentation_load_more": "تحميل المزيد",
      "workspace.documentation_open": "فتح",
      "workspace.documentation_reindex": "إعادة الفهرسة",
      "workspace.documentation_delete_confirm": "هل تريد حذف \"{name}\" نهائيًا؟ لا يمكن التراجع عن هذا الإجراء.",
      "workspace.documentation_status_uploaded": "في الانتظار",
      "workspace.documentation_status_processing": "جارٍ الفهرسة...",
      "workspace.documentation_status_ready": "جاهز",
      "workspace.documentation_status_failed": "فشل",
      "workspace.notifications_button": "الإشعارات",
      "workspace.notifications_title": "الإشعارات",
      "workspace.notifications_mark_all_read": "تحديد الكل كمقروء",
      "workspace.notifications_empty": "لا توجد إشعارات بعد.",
      "workspace.notification_mention": "قام {name} بذكرك",
      "workspace.notification_reply": "رد {name} على رسالتك",
    },
  };
