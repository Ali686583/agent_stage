...
(function () {
  ...
  const DICTIONARIES = {
    fr: {
      ...
      "workspace.shared_projects": "Projets communs",
      "workspace.new_shared_project": "+ Nouveau projet commun",
      "workspace.shared_project_name_placeholder": "Nom du projet commun...",
      "workspace.no_shared_projects": "Aucun projet commun pour l'instant.",
      "workspace.dictate_button": "Dictée vocale",
      "workspace.dictate_not_supported": "Dictée non prise en charge par ce navigateur.",
      "workspace.dictate_mic_denied": "Accès au microphone refusé.",
      "workspace.dictate_error": "Erreur de dictée vocale.",
      "workspace.creator_label": "Créateur :",
      "workspace.creator_unknown": "inconnu",
      "workspace.connections_button": "Plateformes / API",
      "workspace.connections_menu_title": "Plateformes / API",
      "workspace.add_connection": "+ Ajouter une connexion",
      "workspace.no_connections": "Aucune connexion enregistrée.",
      "workspace.connection_name_placeholder": "Nom (ex : API Finance)",
      "workspace.connection_type_placeholder": "Plateforme / type (ex : Google Drive)",
      "workspace.connection_api_key_placeholder": "Clé API",
      "workspace.connection_keywords_placeholder": "Mots-clés (séparés par des virgules)",
      "workspace.connection_base_url_placeholder": "URL de l'API (optionnel)",
      "workspace.advanced_settings": "Options avancées",
      "workspace.delete_connection": "Supprimer la connexion",
      "workspace.confirm_delete_connection": "Supprimer la connexion « {name} » ?",
    },
    en: {
      ...
      "workspace.shared_projects": "Shared projects",
      "workspace.new_shared_project": "+ New shared project",
      "workspace.shared_project_name_placeholder": "Shared project name...",
      "workspace.no_shared_projects": "No shared project yet.",
      "workspace.dictate_button": "Voice dictation",
      "workspace.dictate_not_supported": "Dictation is not supported by this browser.",
      "workspace.dictate_mic_denied": "Microphone access denied.",
      "workspace.dictate_error": "Voice dictation error.",
      "workspace.creator_label": "Creator:",
      "workspace.creator_unknown": "unknown",
      "workspace.connections_button": "Platforms / API",
      "workspace.connections_menu_title": "Platforms / API",
      "workspace.add_connection": "+ Add a connection",
      "workspace.no_connections": "No connection saved yet.",
      "workspace.connection_name_placeholder": "Name (e.g. Finance API)",
      "workspace.connection_type_placeholder": "Platform / type (e.g. Google Drive)",
      "workspace.connection_api_key_placeholder": "API key",
      "workspace.connection_keywords_placeholder": "Keywords (comma-separated)",
      "workspace.connection_base_url_placeholder": "API URL (optional)",
      "workspace.advanced_settings": "Advanced settings",
      "workspace.delete_connection": "Delete connection",
      "workspace.confirm_delete_connection": "Delete the connection “{name}”?",
    },
    ar: {
      ...
      "workspace.shared_projects": "المشاريع المشتركة",
      "workspace.new_shared_project": "+ مشروع مشترك جديد",
      "workspace.shared_project_name_placeholder": "اسم المشروع المشترك...",
      "workspace.no_shared_projects": "لا يوجد مشروع مشترك بعد.",
      "workspace.dictate_button": "الإملاء الصوتي",
      "workspace.dictate_not_supported": "الإملاء الصوتي غير مدعوم في هذا المتصفح.",
      "workspace.dictate_mic_denied": "تم رفض الوصول إلى الميكروفون.",
      "workspace.dictate_error": "خطأ في الإملاء الصوتي.",
      "workspace.creator_label": "المُنشئ:",
      "workspace.creator_unknown": "غير معروف",
      "workspace.connections_button": "المنصات / واجهات API",
      "workspace.connections_menu_title": "المنصات / واجهات API",
      "workspace.add_connection": "+ إضافة اتصال",
      "workspace.no_connections": "لا يوجد أي اتصال محفوظ.",
      "workspace.connection_name_placeholder": "الاسم (مثال: API المالية)",
      "workspace.connection_type_placeholder": "المنصة / النوع (مثال: Google Drive)",
      "workspace.connection_api_key_placeholder": "مفتاح API",
      "workspace.connection_keywords_placeholder": "كلمات مفتاحية (مفصولة بفواصل)",
      "workspace.connection_base_url_placeholder": "رابط API (اختياري)",
      "workspace.advanced_settings": "إعدادات متقدمة",
      "workspace.delete_connection": "حذف الاتصال",
      "workspace.confirm_delete_connection": "حذف الاتصال «{name}»؟",
    },
  };
